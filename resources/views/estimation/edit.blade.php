                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
                    ...
                    <tbody id="items-body">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                            ...
                            <td class="px-2 py-2"><input type="number" name="items[{{ $loop->index }}][coefficient]" class="form-input" value="{{ $item->coefficient }}" step="0.0001" oninput="updateTotalPrice(this)" placeholder="Koefisien"></td>
