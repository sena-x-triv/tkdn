...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Edit Worker</h1>
            ...
            <form action="{{ route('master.worker.update', $worker) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="unit" name="unit" value="{{ old('unit', $worker->unit) }}" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" id="price" name="price" value="{{ old('price', $worker->price) }}" 
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            <input type="number" id="tkdn" name="tkdn" value="{{ old('tkdn', $worker->tkdn) }}" 
