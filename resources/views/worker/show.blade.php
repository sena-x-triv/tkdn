...
<div class="space-y-6">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Worker Details</h1>
                <p class="text-gray-600 dark:text-gray-400">View worker information</p>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('master.worker.edit', $worker) }}" class="btn btn-outline btn-sm flex items-center">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <!-- Worker Name -->
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Worker Name</label>
                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">{{ $worker->name }}</span>
                        </div>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-gray-900 dark:text-white font-medium">Rp {{ number_format($worker->price, 0, ',', '.') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                            <div class="flex items-center mb-2">
                                ...
                                <span class="text-gray-900 dark:text-white font-medium">{{ number_format($worker->tkdn, 1) }}%</span>
                            </div>
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-3">
                                <div class="bg-green-600 h-3 rounded-full transition-all duration-300" style="width: {{ $worker->tkdn }}%"></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @if($worker->tkdn >= 80)
                            <div class="flex items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-green-700 dark:text-green-300">This worker meets high TKDN requirements</div>
                                </div>
                            </div>
                        @elseif($worker->tkdn >= 60)
                            <div class="flex items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-yellow-700 dark:text-yellow-300">This worker meets moderate TKDN requirements</div>
                                </div>
                            </div>
                        @else
                            <div class="flex items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-red-700 dark:text-red-300">This worker has low TKDN percentage</div>
                                </div>
                            </div>
                        @endif
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-gray-900 dark:text-white">{{ $worker->created_at->format('d M Y, H:i') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <span class="text-gray-900 dark:text-white">{{ $worker->updated_at->format('d M Y, H:i') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-end space-x-4 mt-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <a href="{{ route('master.worker.edit', $worker) }}" class="btn btn-primary flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                        Edit Worker
