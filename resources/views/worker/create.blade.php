                        ...
                        <div>
                            <label for="code" class="form-label">Code <span class="text-red-500">*</span></label>
                                <div class="relative">
                                    ...
                                    <input type="text" name="code" id="code" class="form-input pl-10 @error('code') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('code') }}" required placeholder="Enter worker code">
                                </div>
                            @error('code')
...
$(function() {
    ...
    cities.forEach(function(city) {
        const isSelected = city === oldLocation ? 'selected' : '';
