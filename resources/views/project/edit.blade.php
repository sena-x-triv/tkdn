                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="company" id="company" class="form-input pl-10 @error('company') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('company', $project->company) }}" placeholder="Masukkan nama company">
                            </div>
                            @error('company')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
