...
<div class="space-y-6">
    <div class="mb-8">
        <div class="flex items-center mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">Perbarui data kategori</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('master.category.update', $category) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="name" id="name" class="form-input pl-10 @error('name') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('name', $category->name) }}" required placeholder="Masukkan nama kategori">
                            </div>
                            @error('name')
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="code" id="code" class="form-input pl-10 @error('code') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('code', $category->code) }}" required placeholder="Kode unik, misal: MAT">
                            </div>
                            @error('code')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                            ...
                            <div class="relative">
                                ...
                                <select name="tkdn_type" id="tkdn_type" class="form-input pl-10 @error('tkdn_type') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" required>
                                    ...
                                    @foreach($tkdnTypes as $key => $label)
                                        <option value="{{ $key }}" {{ old('tkdn_type', $category->tkdn_type) == $key ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
