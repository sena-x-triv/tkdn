...
<div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 w-full mx-auto mb-8 border border-gray-100 dark:border-gray-800">
    <form action="{{ route('master.equipment.update', $equipment->id) }}" method="POST" class="space-y-8">
        @csrf
        @method('PUT')
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code', $equipment->code) }}" class="form-input pl-10 w-full @error('code') border-red-500 @enderror" required placeholder="Masukkan kode peralatan">
                </div>
                @error('code')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $equipment->name) }}" class="form-input pl-10 w-full @error('name') border-red-500 @enderror" required placeholder="Masukkan nama peralatan">
                </div>
                @error('name')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select name="category_id" id="category_id" class="form-input pl-10 w-full @error('category_id') border-red-500 @enderror">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="tkdn" id="tkdn" value="{{ old('tkdn', $equipment->tkdn) }}" class="form-input pl-10 w-full @error('tkdn') border-red-500 @enderror" min="0" max="100" step="0.01" placeholder="Masukkan persentase TKDN">
                </div>
                @error('tkdn')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="period" id="period" value="{{ old('period', $equipment->period) }}" class="form-input pl-10 w-full @error('period') border-red-500 @enderror" min="1" required placeholder="Masukkan periode (hari)">
                </div>
                @error('period')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price" id="price" value="{{ old('price', $equipment->price) }}" class="form-input pl-10 w-full @error('price') border-red-500 @enderror" min="0" required placeholder="Masukkan harga peralatan">
                </div>
                @error('price')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="description" id="description" value="{{ old('description', $equipment->description) }}" class="form-input pl-10 w-full @error('description') border-red-500 @enderror" placeholder="Keterangan tambahan (opsional)">
                </div>
                @error('description')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
