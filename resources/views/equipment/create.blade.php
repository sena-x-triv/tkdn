                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="period" id="period" value="{{ old('period') }}" class="form-input pl-10 w-full @error('period') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" min="1" required placeholder="Masukkan periode (hari)">
                            </div>
                            @error('period')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
