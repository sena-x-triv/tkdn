                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="code" id="code" class="form-input pl-10 @error('code') border-red-500 focus:ring-red-500 focus:border-red-500 @enderror" value="{{ old('code', $material->code) }}" required placeholder="Enter material code">
                            </div>
                            @error('code')
...
$(function() {
    ...
    cities.forEach(function(city) {
        const isSelected = city === @json(old('location', $material->location)) ? 'selected' : '';
