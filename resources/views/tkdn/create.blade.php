...
@section('title', 'Tambah Item TKDN')
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Tambah Item TKDN</h1>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('master.tkdn.store') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="name" id="name" rows="3" required
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                                  placeholder="Contoh: Penerimaan dan Pengangkutan Arsip Per Box Standard">{{ old('name') }}</textarea>
                    ...
                    <div>
                        ...
                        <select name="tkdn_classification" id="tkdn_classification" required
                            ...
                            @foreach($classifications as $classification)
                                <option value="{{ $classification }}" {{ old('tkdn_classification') == $classification ? 'selected' : '' }}>
                                    {{ $classification }}
                                </option>
                            @endforeach
                        </select>
